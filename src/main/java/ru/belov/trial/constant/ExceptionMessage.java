...
public class ExceptionMessage {
    ...
    public static final String CLIENT_NAME_IS_EMPTY ="client_name_is_empty";
    public static final String CLIENT_CITY_CODE_IS_NULL ="client_city_code_is_null";
    public static final String CLIENT_CITY_CODE_IS_EMPTY ="client_city_code_is_empty";
    public static final String CLIENT_TYPE_IS_NULL ="client_type_is_null";
